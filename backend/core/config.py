...
class GlobalConfig:
    ...
    def GetApiUrl2(index):
        ...
        # Safe access
        if 0 <= index < len(GlobalConfig.Url2List.value):
            return GlobalConfig.Url2List.value[index]
    ...
    def GetImgUrl2(index):
        ...
        if 0 <= index < len(GlobalConfig.PicUrlList.value):
            return GlobalConfig.PicUrlList.value[index]
