...
✨**JM-Aura** 是一个基于 **JMComic** API开发的🌟第三方JMComic（禁漫天堂）的本地/自建 Web 应用🤗
...
<img width="624" height="1029" alt="手机/平板端界面" src="https://github.com/user-attachments/assets/c55b98ee-3151-43cc-ae88-147ee4bbd603" />
...
- 打开页面后进入 **设置（Config）**，先注册一个Aura账号（站点账号），然后再在相关选项填入 JMComic 账号密码登录你的JM账号。
