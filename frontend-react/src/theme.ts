...
function auraFor(mode: ThemeMode): AuraPalette {
  if (mode === 'dark') {
    return {
      ...
      surfaceContainerLow: '#1F1A15',
      surfaceContainer: '#2A241E',
      surfaceContainerHigh: '#352E27',
      surfaceContainerHighest: '#403930',
      outline: '#998D83',
  ...
  return {
    ...
    surfaceContainerLow: '#FCF0E5',
    surfaceContainer: '#F7EBE0',
    surfaceContainerHigh: '#F1E5DA',
    surfaceContainerHighest: '#EBDFD4',
    outline: '#85746A',
